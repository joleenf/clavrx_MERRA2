...
wget --load-cookies ~/.urs_cookies --save-cookies ~/.urs_cookies --keep-session-cookies --content-disposition https://goldsmr4.gesdisc.eosdis.nasa.gov/data/MERRA2/M2T1NXLND.5.12.4/${YYYY}/${MM}/${TARGET_FILE}

if [ -f "$TARGET_FILE" ]; then
    mv ${TARGET_FILE} 2d_lnd/.
else 
