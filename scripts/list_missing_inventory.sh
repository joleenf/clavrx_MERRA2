...
ls -1 ${DATA_PATH}/merra.${YEAR:2:2}${month}*.hdf > $tmpfile01

while [[ $start_day -le $end_day ]]
do
	echo ${DATA_PATH}/merra.${start_day:2}00_F000.hdf >> $tmpfile02
	echo ${DATA_PATH}/merra.${start_day:2}06_F000.hdf >> $tmpfile02
	echo ${DATA_PATH}/merra.${start_day:2}12_F000.hdf >> $tmpfile02
	echo ${DATA_PATH}/merra.${start_day:2}18_F000.hdf >> $tmpfile02
...
=head1 DESCRIPTION
    ...
    Uses a pre-compiled expected list to compare against files in the merra2 data path.  
