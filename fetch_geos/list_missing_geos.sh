...
if [ $count == 0 ]; then
    ...
    echo "The list generated represents file patterns not found in $DATA_PATH as of $TODAY."
fi
rm $tmpfile01
rm $tmpfile02
...
=head1 NAME
    ...
    list_missing_inventory.sh - List missing GEOS output files generated by month in data directory
